...
{\text{normalization}}
& \text{if } x^2+y^2\le R^2 \text{ and } |x\sin\theta+y\cos\theta|<w \\[3ex]
-1/(\pi R^2)
...
& \text{if } x^2+y^2\le R^2 \text{ and } x\sin\theta+y\cos\theta < 0 \\[3ex]
...
\begin{figure}
\centering
\includegraphics[width=0.32\textwidth]{img/kernel-dfme.png}
\includegraphics[width=0.32\textwidth]{img/kernel-trough.png}
\includegraphics[width=0.32\textwidth]{img/kernel-cliff-veto.png}
